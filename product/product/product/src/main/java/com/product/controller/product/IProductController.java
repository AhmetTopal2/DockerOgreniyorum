...
public interface IProductController {
    ...
    ResponseEntity<BaseResponse<List<Product>>> getProductsByCategoryName(String categoryName);

    ResponseEntity<BaseResponse<List<Product>>> getProductsBySellerName(String sellerName);

    ResponseEntity<BaseResponse<List<Product>>> getProductsByCategoryAndSellerName(String categoryName, String sellerName);
}
